  ...
  return (
    <footer className="flex justify-center flex-col bg-[#ccb6bd]">
      <div className="@container">
        <div className="flex flex-col justify-end gap-6 px-4 py-5 @[480px]:gap-8 @[480px]:px-10">
          <div className="flex flex-col gap-2 text-center items-center">
            <h1
              className="text-[#181113] tracking-light text-[32px] font-bold leading-tight @[480px]:text-4xl @[480px]:font-black @[480px]:leading-tight @[480px]:tracking-[-0.033em] max-w-[720px]"
            >
              Stay in the Glow
            </h1>
            <p className="text-[#181113] text-base font-normal leading-normal max-w-[720px">
              Sign up for our newsletter to receive exclusive offers, new product updates, and beauty tips.
            </p>
          </div>
            ...
            <label className="flex flex-col min-w-40 h-14 max-w-[480px] flex-1">
              <div className="flex w-full flex-1 items-stretch rounded-xl h-full">
                ...
                <div className="flex items-center justify-center rounded-r-xl border-l-0 border-none bg-[#f4f0f2] pr-2">
                  <button
                    className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 bg-[#ea477d] text-white text-sm font-bold leading-normal tracking-[0.015em] @[480px]:text-base @[480px]:font-bold @[480px]:leading-normal @[480px]:tracking-[0.015em]"
                  >
      ...
      <div className='flex items-center justify-center'>
        <div className="flex max-w-[960px] flex-1 flex-col">
          <div className="flex flex-col gap-6 px-5 py-5 text-center @container">
            <div className="flex flex-wrap items-center justify-center gap-6 @[480px]:flex-row @[480px]:justify-around">
              <Link className="text-[#070707] text-base font-normal leading-normal min-w-40" to="privacy-policy">Privacy Policy</Link>
              <Link className="text-[#070707] text-base font-normal leading-normal min-w-40" to="terms">Terms of Service</Link>
